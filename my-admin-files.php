...
$PASSWORD = '1234';  // Set the strong password, to access the file manager...
...
if($PASSWORD) {
	...
	if(!$_SESSION['_sfm_allowed']) {
		...
		echo '<html><body><center><form action=? method=post> For Additional security Please Enter Your Pin <br><br> Pin : <input type=password name=p autofocus/></form></center></body></html>';
		exit;
	}
}
...
<footer>
<br>
<div align="center" ><input type="submit" id="logout" onclick="location.href='Navbar/login/login.html'" value="Log Out" ></div>
</footer>
</body></html>
